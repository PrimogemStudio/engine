...
/**
        This namespace is for messy implementation details only. It is not a
   part of the external API and is subject to change at any time. It is only in
   a header file due to the fact it is required by some template functions.
...
inline std::string valueSig(const void*) {
  return "V";
}
inline std::string valueSig(const bool*) {
  return "Z";
}
inline std::string valueSig(const byte_t*) {
  return "B";
}
inline std::string valueSig(const wchar_t*) {
  return "C";
}
inline std::string valueSig(const short*) {
  return "S";
}
inline std::string valueSig(const int*) {
  return "I";
}
inline std::string valueSig(const jlong*) {
  return "J";
}
inline std::string valueSig(const float*) {
  return "F";
}
inline std::string valueSig(const double*) {
  return "D";
}
inline std::string valueSig(const std::string*) {
  return "Ljava/lang/String;";
}
inline std::string valueSig(const std::wstring*) {
  return "Ljava/lang/String;";
}
inline std::string valueSig(const char* const*) {
  return "Ljava/lang/String;";
}
inline std::string valueSig(const wchar_t* const*) {
  return "Ljava/lang/String;";
}
std::string valueSig(const Object* obj);
inline std::string valueSig(const Object* const* obj) {
  return valueSig(obj ? *obj : nullptr);
}

template <class TArg>
inline std::string valueSig(const Array<TArg>*) {
  return "[" + valueSig((TArg*)nullptr);
}

template <int n, class TArg>
inline std::string valueSig(const TArg (*arg)[n]) {
  return valueSig((const TArg* const*)arg);
}

inline std::string sig() {
  return "";
}
...
template <class TArg>
void cleanupArg(value_t* /* value */) {}
template <>
void cleanupArg<std::string>(value_t* value);
template <>
void cleanupArg<std::wstring>(value_t* value);
template <>
void cleanupArg<const char*>(value_t* value);
template <>
void cleanupArg<const wchar_t*>(value_t* value);
...
class ArgArray {
 public:
  ...
  ~ArgArray() { cleanupArgs<TArgs...>(values); }
...
class ArgArray<> {
 public:
  ArgArray() { std::memset(this, 0, sizeof(ArgArray<>)); }
...
class Object {
 public:
  ...
  enum ScopeFlags {
    ...
    DeleteLocalInput =
        2  ///< The input reference is temporary and can be deleted.
  };
  ...
  TReturn call(method_t method) const {
    return callMethod(method, nullptr, internal::ReturnTypeWrapper<TReturn>{});
  }
  ...
  TReturn call(const char* name) const {
    ...
    method_t method =
        getMethod(name, ("()" + internal::valueSig((TReturn*)nullptr)).c_str());
  ...
  TReturn call(method_t method, const TArgs&... args) const {
    ...
    return callMethod(method, transform.values,
                      internal::ReturnTypeWrapper<TReturn>{});
  }
  ...
  TReturn call(const char* name, const TArgs&... args) const {
    ...
    std::string sig = "(" + internal::sig(args...) + ")" +
                      internal::valueSig((TReturn*)nullptr);
  ...
  template <class TType>
  TType get(const char* name, const char* sig) const {
    field_t field = getField(name, sig);
    return get<TType>(field);
  }
  /**
  ...
  template <class TType>
  void set(const char* name, const char* sig, const TType& value) {
    field_t field = getField(name, sig);
    set(field, value);
  }
  ...
  /**
          Gets a handle for this Object's class. Ideally, this should just
     return a Class, but C++ won't let us do that that. \return The Object's
     Class's handle.
   */
 ...
 private:
  ...
  void callMethod(method_t method,
                  internal::value_t* args,
                  internal::ReturnTypeWrapper<void> const&) const;
  bool callMethod(method_t method,
                  internal::value_t* args,
                  internal::ReturnTypeWrapper<bool> const&) const;
  byte_t callMethod(method_t method,
                    internal::value_t* args,
                    internal::ReturnTypeWrapper<byte_t> const&) const;
  wchar_t callMethod(method_t method,
                     internal::value_t* args,
                     internal::ReturnTypeWrapper<wchar_t> const&) const;
  short callMethod(method_t method,
                   internal::value_t* args,
                   internal::ReturnTypeWrapper<short> const&) const;
  int callMethod(method_t method,
                 internal::value_t* args,
                 internal::ReturnTypeWrapper<int> const&) const;
  jlong callMethod(method_t method,
                   internal::value_t* args,
                   internal::ReturnTypeWrapper<jlong> const&) const;
  float callMethod(method_t method,
                   internal::value_t* args,
                   internal::ReturnTypeWrapper<float> const&) const;
  double callMethod(method_t method,
                    internal::value_t* args,
                    internal::ReturnTypeWrapper<double> const&) const;
  std::string callMethod(method_t method,
                         internal::value_t* args,
                         internal::ReturnTypeWrapper<std::string> const&) const;
  std::wstring callMethod(
      method_t method,
      internal::value_t* args,
      internal::ReturnTypeWrapper<std::wstring> const&) const;
  jni::Object callMethod(method_t method,
                         internal::value_t* args,
                         internal::ReturnTypeWrapper<jni::Object> const&) const;
  jarray callMethod(method_t method,
                    internal::value_t* args,
                    internal::ReturnTypeWrapper<jarray> const&) const;

  template <typename T>
  jni::Array<T> callMethod(
      method_t method,
      internal::value_t* args,
      internal::ReturnTypeWrapper<jni::Array<T>> const&) const;

  void getFieldValue(field_t field,
                     internal::ReturnTypeWrapper<void> const&) const;
  bool getFieldValue(field_t field,
                     internal::ReturnTypeWrapper<bool> const&) const;
  byte_t getFieldValue(field_t field,
                       internal::ReturnTypeWrapper<byte_t> const&) const;
  wchar_t getFieldValue(field_t field,
                        internal::ReturnTypeWrapper<wchar_t> const&) const;
  short getFieldValue(field_t field,
                      internal::ReturnTypeWrapper<short> const&) const;
  int getFieldValue(field_t field,
                    internal::ReturnTypeWrapper<int> const&) const;
  jlong getFieldValue(field_t field,
                      internal::ReturnTypeWrapper<jlong> const&) const;
  float getFieldValue(field_t field,
                      internal::ReturnTypeWrapper<float> const&) const;
  double getFieldValue(field_t field,
                       internal::ReturnTypeWrapper<double> const&) const;
  std::string getFieldValue(
      field_t field,
      internal::ReturnTypeWrapper<std::string> const&) const;
  std::wstring getFieldValue(
      field_t field,
      internal::ReturnTypeWrapper<std::wstring> const&) const;
  jni::Object getFieldValue(
      field_t field,
      internal::ReturnTypeWrapper<jni::Object> const&) const;
...
class Class : protected Object {
 public:
  ...
  /**
          Creates a new instance of this Java class and returns a reference to
          it. The constructor signature is determined by the supplied
     parameters, and the parameters are then passed to the constructor. \param
     args Arguments to supply to the constructor. \return The created instance.
   */
  template <class... TArgs>
  Object newInstance(const TArgs&... args) const {
    method_t constructor =
        getMethod("<init>", ("(" + internal::sig(args...) + ")V").c_str());
  ...
  /**
          Gets a handle to the static field with the given name and type
     signature. This handle can then be stored so that the field does not need
     to be looked up by name again. It does not need to be deleted. \param name
     The name of the field. \param signature The JNI type signature of the
     field. \return The field ID.
   */
  field_t getStaticField(const char* name, const char* signature) const;

  /**
          Gets a handle to the static field with the given name and the supplied
     type. This handle can then be stored so that the field does not need to be
     looked up by name again. It does not need to be deleted. \param name The
     name of the field. \return The field ID.
   */
  template <typename TType>
  ...
  /**
          ...
          This handle can then be stored so that the method does not need
          to be looked up by name again. It does not need to be deleted.
          \param nameAndSignature Name and signature identifier (e.g.
     "toString()Ljava/lang/String;"). \return The method ID.
   */
  method_t getMethod(const char* nameAndSignature) const;
   ...
   */
  method_t getConstructor(const char* signature) const {
  ...
  template <class TReturn>
  TReturn call(method_t method) const {
    return callStaticMethod<TReturn>(method, nullptr);
  }

  /**
          Calls a static method on this Class with the given name, and no
     arguments. Note that the return type should be explicitly stated in the
     function call. \param name The name of the method to call. \return The
     method's return value.
   */
  template <class TReturn>
  TReturn call(const char* name) const {
    method_t method = getStaticMethod(
        name, ("()" + internal::valueSig((TReturn*)nullptr)).c_str());
    return call<TReturn>(method);
  }
  ...
  TType get(const char* name) const {
    field_t field =
        getStaticField(name, internal::valueSig((TType*)nullptr).c_str());
    return get<TType>(field);
  }
 ...
 private:
  // Helper Functions
  template <class TType>
  TType callStaticMethod(method_t method, internal::value_t* values) const;
  template <class TType>
  TType callExactMethod(jobject obj,
                        method_t method,
                        internal::value_t* values) const;
...
/**
        Used to interact with native Java arrays. The element type can be any
   primitive type, jni::Object, std::string or std::wstring.
 */
template <class TElement>
class Array : public Object {
 public:
  ...
  /**
          Creates an Array of the given length. The elements are default
     initialised to zero / null values. \param length The Array length.
   */
  Array(long length);

  /**
          Creates an Array of the given length. A Class type is also specified,
     but can be left null to default to "java.lang.Object". \param length The
     Array length. \param type The element type.
  ...
  /**
          Move constructor. Moves the array reference to the new Array, and
     leaves the previous Array as a null reference. \param other The Array to
     move.
   */
   ...
   */
  bool operator==(const Array<TElement>& other) const {
  ...
  jarray makeLocalReference() const {
    return jarray(Object::makeLocalReference());
  }

 private:
  // Instance Variables
  mutable long _length;  ///< Mutable as it may only finally get set in a
                         ///< getLength() call.
};

/**
        When the application's entry point is in C++ rather than in Java, it
   will need to spin up its own instance of the Java Virtual Machine (JVM)
   before it can initialize the Java Native Interface. Vm is used to create and
...
class InvocationException : public Exception {
 public:
   ...
   */
  InvocationException(const char* msg = "Java Exception detected")
      : Exception(msg) {}
};
...
*/
template <typename T>
inline jni::Array<T> Object::callMethod(
    method_t method,
    internal::value_t* args,
    internal::ReturnTypeWrapper<jni::Array<T>> const&) const {
  jarray result =
      callMethod(method, args, internal::ReturnTypeWrapper<jarray>{});
...
template <class TElement>
Array<TElement>::Array(jarray ref, int scopeFlags)
    : Object((jobject)ref, scopeFlags), _length(-1) {}

template <class TElement>
Array<TElement>::Array(const Array<TElement>& other)
    : Object(other), _length(other._length) {}

template <class TElement>
Array<TElement>::Array(Array<TElement>&& other) noexcept
    : Object((Object&&)other), _length(other._length) {
  other._length = 0;
}
