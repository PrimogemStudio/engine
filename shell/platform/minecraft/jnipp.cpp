...
static JNIEnv* env() {
  if (isAttached(javaVm)) {
    JNIEnv* env;
    getEnv(javaVm, &env);
    return env;
  }
  throw Exception("can't get env");
}
...
Object::Object() noexcept
    : _handle(nullptr), _class(nullptr), _isGlobal(false) {}

Object::Object(const Object& other)
    : _handle(nullptr), _class(nullptr), _isGlobal(!other.isNull()) {
  if (!other.isNull())
    _handle = env()->NewGlobalRef(other._handle);
}

Object::Object(Object&& other) noexcept
    : _handle(other._handle), _class(other._class), _isGlobal(other._isGlobal) {
  other._handle = nullptr;
  other._class = nullptr;
  other._isGlobal = false;
}

Object::Object(jobject ref, int scopeFlags)
    : _handle(ref), _class(nullptr), _isGlobal((scopeFlags & Temporary) == 0) {
  if (!_isGlobal)
    return;
...
void Object::callMethod(method_t method,
                        internal::value_t* args,
                        internal::ReturnTypeWrapper<void> const&) const {
  env()->CallVoidMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
}

bool Object::callMethod(method_t method,
                        internal::value_t* args,
                        internal::ReturnTypeWrapper<bool> const&) const {
  auto result = env()->CallBooleanMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return result != 0;
}

bool Object::getFieldValue(field_t field,
                           internal::ReturnTypeWrapper<bool> const&) const {
  return env()->GetBooleanField(_handle, field) != 0;
}

template <>
void Object::set(field_t field, const bool& value) {
  env()->SetBooleanField(_handle, field, value);
}

byte_t Object::callMethod(method_t method,
                          internal::value_t* args,
                          internal::ReturnTypeWrapper<byte_t> const&) const {
  auto result = env()->CallByteMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

wchar_t Object::callMethod(method_t method,
                           internal::value_t* args,
                           internal::ReturnTypeWrapper<wchar_t> const&) const {
  auto result = env()->CallCharMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

short Object::callMethod(method_t method,
                         internal::value_t* args,
                         internal::ReturnTypeWrapper<short> const&) const {
  auto result = env()->CallShortMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

int Object::callMethod(method_t method,
                       internal::value_t* args,
                       internal::ReturnTypeWrapper<int> const&) const {
  auto result = env()->CallIntMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

jlong Object::callMethod(method_t method,
                         internal::value_t* args,
                         internal::ReturnTypeWrapper<jlong> const&) const {
  auto result = env()->CallLongMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

float Object::callMethod(method_t method,
                         internal::value_t* args,
                         internal::ReturnTypeWrapper<float> const&) const {
  auto result = env()->CallFloatMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

double Object::callMethod(method_t method,
                          internal::value_t* args,
                          internal::ReturnTypeWrapper<double> const&) const {
  auto result = env()->CallDoubleMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

std::string Object::callMethod(
    method_t method,
    internal::value_t* args,
    internal::ReturnTypeWrapper<std::string> const&) const {
  auto result = env()->CallObjectMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return toString(result);
}

std::wstring Object::callMethod(
    method_t method,
    internal::value_t* args,
    internal::ReturnTypeWrapper<std::wstring> const&) const {
  auto result = env()->CallObjectMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return toWString(result);
}

jni::Object Object::callMethod(
    method_t method,
    internal::value_t* args,
    internal::ReturnTypeWrapper<jni::Object> const&) const {
  auto result = env()->CallObjectMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return Object(result, DeleteLocalInput);
}

jarray Object::callMethod(method_t method,
                          internal::value_t* args,
                          internal::ReturnTypeWrapper<jarray> const&) const {
  auto result = env()->CallObjectMethodA(_handle, method, (jvalue*)args);
  handleJavaExceptions();
  return (jarray)result;
}

byte_t Object::getFieldValue(field_t field,
                             internal::ReturnTypeWrapper<byte_t> const&) const {
  return env()->GetByteField(_handle, field);
}

wchar_t Object::getFieldValue(
    field_t field,
    internal::ReturnTypeWrapper<wchar_t> const&) const {
  return env()->GetCharField(_handle, field);
}

short Object::getFieldValue(field_t field,
                            internal::ReturnTypeWrapper<short> const&) const {
  return env()->GetShortField(_handle, field);
}

int Object::getFieldValue(field_t field,
                          internal::ReturnTypeWrapper<int> const&) const {
  return env()->GetIntField(_handle, field);
}

jlong Object::getFieldValue(field_t field,
                            internal::ReturnTypeWrapper<jlong> const&) const {
  return env()->GetLongField(_handle, field);
}

float Object::getFieldValue(field_t field,
                            internal::ReturnTypeWrapper<float> const&) const {
  return env()->GetFloatField(_handle, field);
}

double Object::getFieldValue(field_t field,
                             internal::ReturnTypeWrapper<double> const&) const {
  return env()->GetDoubleField(_handle, field);
}

std::string Object::getFieldValue(
    field_t field,
    internal::ReturnTypeWrapper<std::string> const&) const {
  return toString(env()->GetObjectField(_handle, field));
}

std::wstring Object::getFieldValue(
    field_t field,
    internal::ReturnTypeWrapper<std::wstring> const&) const {
  return toWString(env()->GetObjectField(_handle, field));
}

Object Object::getFieldValue(field_t field,
                             internal::ReturnTypeWrapper<Object> const&) const {
  return Object(env()->GetObjectField(_handle, field), DeleteLocalInput);
}

template <>
void Object::set(field_t field, const byte_t& value) {
  env()->SetByteField(_handle, field, value);
}

template <>
void Object::set(field_t field, const wchar_t& value) {
  env()->SetCharField(_handle, field, value);
}

template <>
void Object::set(field_t field, const short& value) {
  env()->SetShortField(_handle, field, value);
}

template <>
void Object::set(field_t field, const int& value) {
  env()->SetIntField(_handle, field, value);
}

template <>
void Object::set(field_t field, const jlong& value) {
  env()->SetLongField(_handle, field, value);
}

template <>
void Object::set(field_t field, const float& value) {
  env()->SetFloatField(_handle, field, value);
}

template <>
void Object::set(field_t field, const double& value) {
  env()->SetDoubleField(_handle, field, value);
}

template <>
void Object::set(field_t field, const std::string& value) {
  JNIEnv* env = jni::env();
...
template <>
void Object::set(field_t field, const std::wstring& value) {
  JNIEnv* env = jni::env();

#ifdef _WIN32
  jobject handle =
      env->NewString((const jchar*)value.c_str(), jsize(value.length()));
#else
...
template <>
void Object::set(field_t field, const wchar_t* const& value) {
  JNIEnv* env = jni::env();
#ifdef _WIN32
  jobject handle =
      env->NewString((const jchar*)value, jsize(std::wcslen(value)));
#else
...
template <>
void Object::set(field_t field, const char* const& value) {
  JNIEnv* env = jni::env();
...
template <>
void Object::set(field_t field, const Object& value) {
  env()->SetObjectField(_handle, field, value.getHandle());
}

template <>
void Object::set(field_t field, const Object* const& value) {
...
method_t Class::getMethod(const char* nameAndSignature) const {
  ...
  if (sig != nullptr)
    return getMethod(
        std::string(nameAndSignature, sig - nameAndSignature).c_str(), sig);
...
template <>
bool Class::get(field_t field) const {
  return env()->GetStaticBooleanField(getHandle(), field) != 0;
}

template <>
byte_t Class::get(field_t field) const {
  return env()->GetStaticByteField(getHandle(), field);
}

template <>
wchar_t Class::get(field_t field) const {
  return env()->GetStaticCharField(getHandle(), field);
}

template <>
short Class::get(field_t field) const {
  return env()->GetStaticShortField(getHandle(), field);
}

template <>
int Class::get(field_t field) const {
  return env()->GetStaticIntField(getHandle(), field);
}

template <>
jlong Class::get(field_t field) const {
  return env()->GetStaticLongField(getHandle(), field);
}

template <>
float Class::get(field_t field) const {
  return env()->GetStaticFloatField(getHandle(), field);
}

template <>
double Class::get(field_t field) const {
  return env()->GetStaticDoubleField(getHandle(), field);
}

template <>
std::string Class::get(field_t field) const {
  return toString(env()->GetStaticObjectField(getHandle(), field));
}

template <>
std::wstring Class::get(field_t field) const {
  return toWString(env()->GetStaticObjectField(getHandle(), field));
}

template <>
Object Class::get(field_t field) const {
  return Object(env()->GetStaticObjectField(getHandle(), field),
                DeleteLocalInput);
}

template <>
void Class::set(field_t field, const bool& value) {
  env()->SetStaticBooleanField(getHandle(), field, value);
}

template <>
void Class::set(field_t field, const byte_t& value) {
  env()->SetStaticByteField(getHandle(), field, value);
}

template <>
void Class::set(field_t field, const wchar_t& value) {
  env()->SetStaticCharField(getHandle(), field, value);
}

template <>
void Class::set(field_t field, const short& value) {
  env()->SetStaticShortField(getHandle(), field, value);
}

template <>
void Class::set(field_t field, const int& value) {
  env()->SetStaticIntField(getHandle(), field, value);
}

template <>
void Class::set(field_t field, const jlong& value) {
  env()->SetStaticLongField(getHandle(), field, value);
}

template <>
void Class::set(field_t field, const float& value) {
  env()->SetStaticFloatField(getHandle(), field, value);
}

template <>
void Class::set(field_t field, const double& value) {
  env()->SetStaticDoubleField(getHandle(), field, value);
}

template <>
void Class::set(field_t field, const Object& value) {
  env()->SetStaticObjectField(getHandle(), field, value.getHandle());
}

template <>
void Class::set(field_t field, const Object* const& value) {
  env()->SetStaticObjectField(getHandle(), field,
                              value ? value->getHandle() : nullptr);
}

template <>
void Class::set(field_t field, const std::string& value) {
  JNIEnv* env = jni::env();
...
template <>
void Class::set(field_t field, const std::wstring& value) {
  JNIEnv* env = jni::env();
...
template <>
void Class::callStaticMethod(method_t method, internal::value_t* args) const {
  env()->CallStaticVoidMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
}

template <>
bool Class::callStaticMethod(method_t method, internal::value_t* args) const {
  auto result =
      env()->CallStaticBooleanMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result != 0;
}

template <>
byte_t Class::callStaticMethod(method_t method, internal::value_t* args) const {
  auto result =
      env()->CallStaticByteMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

template <>
wchar_t Class::callStaticMethod(method_t method,
                                internal::value_t* args) const {
  auto result =
      env()->CallStaticCharMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

template <>
short Class::callStaticMethod(method_t method, internal::value_t* args) const {
  auto result =
      env()->CallStaticShortMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

template <>
int Class::callStaticMethod(method_t method, internal::value_t* args) const {
...
template <>
jlong Class::callStaticMethod(method_t method, internal::value_t* args) const {
  auto result =
      env()->CallStaticLongMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

template <>
float Class::callStaticMethod(method_t method, internal::value_t* args) const {
  auto result =
      env()->CallStaticFloatMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

template <>
double Class::callStaticMethod(method_t method, internal::value_t* args) const {
  auto result =
      env()->CallStaticDoubleMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

template <>
std::string Class::callStaticMethod(method_t method,
                                    internal::value_t* args) const {
  auto result =
      env()->CallStaticObjectMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return toString(result);
}

template <>
std::wstring Class::callStaticMethod(method_t method,
                                     internal::value_t* args) const {
  auto result =
      env()->CallStaticObjectMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
...
template <>
jni::Object Class::callStaticMethod(method_t method,
                                    internal::value_t* args) const {
  auto result =
      env()->CallStaticObjectMethodA(getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
...
template <>
void Class::callExactMethod(jobject obj,
                            method_t method,
                            internal::value_t* args) const {
...
template <>
bool Class::callExactMethod(jobject obj,
                            method_t method,
                            internal::value_t* args) const {
  auto result = env()->CallNonvirtualBooleanMethodA(obj, getHandle(), method,
                                                    (jvalue*)args);
  handleJavaExceptions();
  return result != 0;
}
...
template <>
byte_t Class::callExactMethod(jobject obj,
                              method_t method,
                              internal::value_t* args) const {
  auto result =
      env()->CallNonvirtualByteMethodA(obj, getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}
...
wchar_t Class::callExactMethod(jobject obj,
                               ...
                               internal::value_t* args) const {
  auto result =
      env()->CallNonvirtualCharMethodA(obj, getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

template <>
short Class::callExactMethod(jobject obj,
                             method_t method,
                             internal::value_t* args) const {
  auto result = env()->CallNonvirtualShortMethodA(obj, getHandle(), method,
                                                  (jvalue*)args);
  handleJavaExceptions();
  return result;
}
...
template <>
int Class::callExactMethod(jobject obj,
                           method_t method,
                           internal::value_t* args) const {
  auto result =
      env()->CallNonvirtualIntMethodA(obj, getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

template <>
jlong Class::callExactMethod(jobject obj,
                             method_t method,
                             internal::value_t* args) const {
  auto result =
      env()->CallNonvirtualLongMethodA(obj, getHandle(), method, (jvalue*)args);
  handleJavaExceptions();
  return result;
}

template <>
float Class::callExactMethod(jobject obj,
                             method_t method,
                             internal::value_t* args) const {
  auto result = env()->CallNonvirtualFloatMethodA(obj, getHandle(), method,
                                                  (jvalue*)args);
  handleJavaExceptions();
  return result;
}
...
template <>
double Class::callExactMethod(jobject obj,
                              method_t method,
                              internal::value_t* args) const {
  auto result = env()->CallNonvirtualDoubleMethodA(obj, getHandle(), method,
                                                   (jvalue*)args);
  handleJavaExceptions();
  return result;
}
...
template <>
std::string Class::callExactMethod(jobject obj,
                                   method_t method,
                                   internal::value_t* args) const {
  auto result = env()->CallNonvirtualObjectMethodA(obj, getHandle(), method,
                                                   (jvalue*)args);
  handleJavaExceptions();
  return toString(result);
}
...
template <>
std::wstring Class::callExactMethod(jobject obj,
                                    method_t method,
                                    internal::value_t* args) const {
  auto result = env()->CallNonvirtualObjectMethodA(obj, getHandle(), method,
                                                   (jvalue*)args);
...
template <>
Object Class::callExactMethod(jobject obj,
                              method_t method,
                              internal::value_t* args) const {
  auto result = env()->CallNonvirtualObjectMethodA(obj, getHandle(), method,
                                                   (jvalue*)args);
...
template <>
Array<bool>::Array(long length)
    : Object(env()->NewBooleanArray(length), DeleteLocalInput),
      _length(length) {}

template <>
Array<byte_t>::Array(long length)
    : Object(env()->NewByteArray(length), DeleteLocalInput), _length(length) {}

template <>
Array<wchar_t>::Array(long length)
    : Object(env()->NewCharArray(length), DeleteLocalInput), _length(length) {}

template <>
Array<short>::Array(long length)
    : Object(env()->NewShortArray(length), DeleteLocalInput), _length(length) {}

template <>
Array<int>::Array(long length)
    : Object(env()->NewIntArray(length), DeleteLocalInput), _length(length) {}

template <>
Array<jlong>::Array(long length)
    : Object(env()->NewLongArray(length), DeleteLocalInput), _length(length) {}

template <>
Array<float>::Array(long length)
    : Object(env()->NewFloatArray(length), DeleteLocalInput), _length(length) {}

template <>
Array<double>::Array(long length)
    : Object(env()->NewDoubleArray(length), DeleteLocalInput),
      _length(length) {}

template <>
Array<std::string>::Array(long length)
    : Object(env()->NewObjectArray(length,
                                   Class("java/lang/String").getHandle(),
                                   nullptr),
             DeleteLocalInput),
      _length(length) {}

template <>
Array<std::wstring>::Array(long length)
    : Object(env()->NewObjectArray(length,
                                   Class("java/lang/String").getHandle(),
                                   nullptr),
             DeleteLocalInput),
...
template <>
Array<Object>::Array(long length)
    : Object(env()->NewObjectArray(length,
                                   Class("java/lang/Object").getHandle(),
                                   nullptr),
             DeleteLocalInput),
      _length(length) {}

template <>
Array<Object>::Array(long length, const Class& type)
    : Object(env()->NewObjectArray(length, type.getHandle(), nullptr),
             DeleteLocalInput),
      _length(length) {}

template <>
bool Array<bool>::getElement(long index) const {
  jboolean output;
...
template <>
byte_t Array<byte_t>::getElement(long index) const {
  jbyte output;
...
template <>
wchar_t Array<wchar_t>::getElement(long index) const {
  jchar output;
...
template <>
short Array<short>::getElement(long index) const {
  jshort output;
...
template <>
int Array<int>::getElement(long index) const {
  jint output;
...
template <>
jlong Array<jlong>::getElement(long index) const {
  jlong output;
...
template <>
float Array<float>::getElement(long index) const {
  jfloat output;
...
template <>
double Array<double>::getElement(long index) const {
  jdouble output;
...
template <>
std::string Array<std::string>::getElement(long index) const {
  jobject output =
      env()->GetObjectArrayElement(jobjectArray(getHandle()), index);
  handleJavaExceptions();
  return toString(output);
}

template <>
std::wstring Array<std::wstring>::getElement(long index) const {
  jobject output =
      env()->GetObjectArrayElement(jobjectArray(getHandle()), index);
  handleJavaExceptions();
...
template <>
Object Array<Object>::getElement(long index) const {
  jobject output =
      env()->GetObjectArrayElement(jobjectArray(getHandle()), index);
  handleJavaExceptions();
...
template <>
void Array<bool>::setElement(long index, bool value) {
...
template <>
void Array<byte_t>::setElement(long index, byte_t value) {
  jbyte jvalue = value;
...
template <>
void Array<wchar_t>::setElement(long index, wchar_t value) {
  jchar jvalue = value;
...
template <>
void Array<short>::setElement(long index, short value) {
  jshort jvalue = value;
...
template <>
void Array<int>::setElement(long index, int value) {
  jint jvalue = value;
...
template <>
void Array<jlong>::setElement(long index, jlong value) {
  jlong jvalue = value;
...
template <>
void Array<float>::setElement(long index, float value) {
  jfloat jvalue = value;
...
template <>
void Array<double>::setElement(long index, double value) {
...
template <>
void Array<std::string>::setElement(long index, std::string value) {
  JNIEnv* env = jni::env();
...
template <>
void Array<std::wstring>::setElement(long index, std::wstring value) {
  JNIEnv* env = jni::env();
...
template <>
void Array<Object>::setElement(long index, Object value) {
  env()->SetObjectArrayElement(jobjectArray(getHandle()), index,
                               value.getHandle());
  handleJavaExceptions();
}
...
static std::pair<ssize_t, std::string> readlink_as_string(
    const char* pathname) {
  char buf[2048] = {};
...
static std::string drop_path_components(const std::string& path,
...
static std::string detectJvmPath() {
  ...
  if (::RegOpenKeyA(HKEY_LOCAL_MACHINE,
    ...
    if (::RegQueryValueExA(versionKey, "CurrentVersion", NULL, NULL, buffer,
                           &size) == ERROR_SUCCESS) {
      HKEY libKey;

      std::string keyName =
          std::string("Software\\JavaSoft\\Java Runtime Environment\\") +
          (const char*)buffer;

      ::RegCloseKey(versionKey);

      if (::RegOpenKeyA(HKEY_LOCAL_MACHINE, keyName.c_str(), &libKey) ==
          ERROR_SUCCESS) {
        size = sizeof(buffer);

        if (::RegQueryValueExA(libKey, "RuntimeLib", NULL, NULL, buffer,
                               &size) == ERROR_SUCCESS) {
  ...
  if (result.length() == 0) {
    ...
    if ((size = ::GetEnvironmentVariableA("JAVA_HOME", (LPSTR)buffer,
                                          sizeof(buffer))) != 0) {
      std::string javaHome((const char*)buffer, size);

      // Different installers put in different relative locations.
      std::string options[] = {javaHome + "\\jre\\bin\\client\\jvm.dll",
  ...
  if (javaHome != nullptr) {
    ...
    std::string libJvmPath =
        std::string(javaHome) + "/jre/lib/server/libjvm.dylib";
#else
    std::string libJvmPath =
        std::string(javaHome) + "/jre/lib/amd64/server/libjvm.so";
#endif
    result = libJvmPath;
  } else {
...
Vm::Vm(const char* path_) {
  ...
  if (javaVm == nullptr) {
    ...
    CreateVm_t JNI_CreateJavaVM =
        (CreateVm_t)::GetProcAddress(lib, "JNI_CreateJavaVM");

    /**
            Is your debugger catching an error here?  This is normal.  Just
       continue. The JVM intentionally does this to test how the OS handles
       memory-reference exceptions.
     */
    if (JNI_CreateJavaVM == NULL ||
        JNI_CreateJavaVM(&javaVm, (void**)&env, &args) != 0) {
      isVm.store(false);
      ::FreeLibrary(lib);
      throw InitializationException(
          "Java Virtual Machine failed during creation");
    }
...
void valueArg(value_t* v, jlong a) {
  ((jvalue*)v)->j = a;
}
...
void valueArg(value_t* v, const Object& a) {
  ((jvalue*)v)->l = a.getHandle();
}
void valueArg(value_t* v, const Object* const& a) {
  ((jvalue*)v)->l = a ? a->getHandle() : nullptr;
}
...
template <>
void cleanupArg<std::string>(value_t* v) {
...
template <>
void cleanupArg<const char*>(value_t* v) {
  env()->DeleteLocalRef(((jvalue*)v)->l);
}
#ifdef _WIN32
...
void valueArg(value_t* v, const std::wstring& a) {
  ((jvalue*)v)->l =
      env()->NewString((const jchar*)a.c_str(), jsize(a.length()));
}
...
void valueArg(value_t* v, const std::wstring& a) {
  ...
  ((jvalue*)v)->l =
      env()->NewString((jchar*)jstr.c_str(), jsize(jstr.length()));
}
...
template <>
void cleanupArg<const std::wstring*>(value_t* v) {
  env()->DeleteLocalRef(((jvalue*)v)->l);
}

template <>
void cleanupArg<const wchar_t*>(value_t* v) {
  env()->DeleteLocalRef(((jvalue*)v)->l);
}
